  ...
  return <div className="grain min-h-screen">
    ...
    <main className="mx-auto max-w-[1440px] px-5 py-8 lg:px-10 lg:py-12">
      ...
      {view === "library" && <section className="rise">
        ...
        <form onSubmit={addExternal} className="mb-6 flex flex-col gap-3 rounded-2xl border border-[#deddd5] bg-white/55 p-4 sm:flex-row sm:items-center"><div className="shrink-0 text-xs font-bold uppercase tracking-wider text-[#68736f]">arXiv / DOI</div><input value={externalId} onChange={e => setExternalId(e.target.value)} placeholder="例：2401.12345 または 10.1000/..." className="min-w-0 flex-1 rounded-xl border border-[#d5d8d2] bg-white px-4 py-2.5 text-sm outline-none focus:border-[#6c887a]"/><button disabled={!externalId.trim() || uploading} className="rounded-full border border-[#164f3b] px-5 py-2.5 text-xs font-semibold text-[#164f3b] disabled:opacity-40">メタデータ取得</button></form>
